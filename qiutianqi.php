...
/* 
文中所有{@求天气}全部改成你的昵称
开启SAE Memcache服务，1M大小即可
将此文件用cron每分钟执行一次
 */
include_once( 'config.php' );
include_once( 'saetv2.ex.class.php' );

$c = new SaeTClientV2( WB_AKEY , WB_SKEY , '2.00hIxxcC2t5cXEcceccdcb2f0VqusC' );//这里改成你的token
$c->set_debug( DEBUG_MODE );
$fensi = $c->followers_by_id( '2399140883' , $cursor = 0 , $count = 50);//得到粉丝列表，这里改成你的微博id
